...
<?php $component->withAttributes([]); ?>
    ...
    <div class="card-body">
        ...
        <h1 class="mb-3 text-gray-800 h3"><?php echo e(__('Create Admin')); ?></h1>

        <form class="my-3" action="<?php echo e(route('admins.admins.store')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" class="form-control" id="email"
                    placeholder="<?php echo e(__('Email')); ?>" required value="<?php echo e(old('email')); ?>">
            </div>

            <div class="form-group">
                <label for="password"><?php echo e(__('Password')); ?></label>
                <input type="password" name="password" class="form-control" id="password"
                    placeholder="<?php echo e(__('Password')); ?>" required value="<?php echo e(old('password')); ?>">
            </div>

            <div class="form-group">
                <label for="password_confirmation"><?php echo e(__('Confirm Password')); ?></label>
                <input type="password" name="password_confirmation" class="form-control"
                    id="password_confirmation" placeholder="<?php echo e(__('Confirm Password')); ?>" required
            ...
            <button type="submit" class="btn btn-success btn-block mb_40"><?php echo e(__('Create Admin')); ?></button>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\dalel-madinaty\resources\views/admin/admins/create.blade.php ENDPATH**/ ?>