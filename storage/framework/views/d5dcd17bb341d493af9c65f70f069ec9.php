...
<?php $component->withAttributes([]); ?>
    ...
    <div class="card-body">
        <form class="my-3" action="<?php echo e(route('admins.option-values.store')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\dalel-madinaty\resources\views/admin/option-values/create.blade.php ENDPATH**/ ?>