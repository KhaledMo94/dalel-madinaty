...
<?php $component->withAttributes([]); ?>
    ...
    ?>
    <h1 class="mb-3 text-gray-800 h3"><?php echo e(__('Edit Offer')); ?></h1>
    <div class="mb-4 shadow card">
        ...
        <div class="card-body" data-aos="fade-up">
            ...
            <form class="my-3" action="<?php echo e(route('admins.offers.update', $offer->id)); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="content_en"><?php echo e(__('Content (English)')); ?></label>
                            <input type="text" name="content_en" id="content_en" 
                                class="form-control <?php $__errorArgs = ['content_en'];
...
unset($__errorArgs, $__bag); ?>" 
                                placeholder="<?php echo e(__('Content (English)')); ?>"
                                required value="<?php echo e(old('content_en', $offer->getTranslation('content', 'en'))); ?>" maxlength="150">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="content_ar"><?php echo e(__('Content (Arabic)')); ?></label>
                            <input type="text" name="content_ar" id="content_ar" 
                                class="form-control <?php $__errorArgs = ['content_ar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                placeholder="<?php echo e(__('Content (Arabic)')); ?>"
                                required value="<?php echo e(old('content_ar', $offer->getTranslation('content', 'ar'))); ?>" maxlength="150">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="listing_id"><?php echo e(__('Listing')); ?></label>
                            <select name="listing_id" id="listing_id" 
                                class="form-control select2 listing-select <?php $__errorArgs = ['listing_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <?php if($offer->listing): ?>
                                    <option value="<?php echo e($offer->listing_id); ?>" selected>
                                        <?php echo e($offer->listing->getTranslation('name', $locale)); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                required value="<?php echo e(old('start_date', $offer->start_date ? $offer->start_date->format('Y-m-d\TH:i') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                required value="<?php echo e(old('end_date', $offer->end_date ? $offer->end_date->format('Y-m-d\TH:i') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <?php else: ?>
                                <p class="text-muted"><?php echo e(__('No image uploaded')); ?></p>
                            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                            <small class="form-text text-muted"><?php echo e(__('Maximum file size: 5MB. Leave empty to keep current image.')); ?></small>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            <?php if($offer->listing): ?>
                var listingOption = new Option("<?php echo e($offer->listing->getTranslation('name', $locale)); ?>", "<?php echo e($offer->listing_id); ?>", true, true);
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\dalel-madinaty\resources\views/admin/offers/edit.blade.php ENDPATH**/ ?>