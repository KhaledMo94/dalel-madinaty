...
<?php $component->withAttributes([]); ?>
    ...
    <div class="card-body">
        <form class="my-3" action="<?php echo e(route('admins.areas.update', $area->id)); ?>" method="post"
            ...
            <div class="form-group">
                ...
                <select name="city_id" class="form-control" id="city_id" required>
                    ...
                    <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($city->id); ?>" <?php echo e(old('city_id', $area->city_id) == $city->id ? 'selected' : ''); ?>>
            ...
            <div class="form-group">
                ...
                <input type="text" name="name_ar" class="form-control" id="name_ar" placeholder="<?php echo e(__('Name')); ?>"
                    required value="<?php echo e(old('name_ar', $area->getTranslation('name', 'ar'))); ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="name_en" class="form-control" id="name_en"
                    ...
                    value="<?php echo e(old('name_en', $area->getTranslation('name', 'en'))); ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="description_ar" class="form-control" id="description_ar"
                    placeholder="<?php echo e(__('Description in Arabic')); ?>"><?php echo e(old('description_ar', $area->getTranslation('description', 'ar'))); ?></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="description_en" class="form-control" id="description_en"
                    placeholder="<?php echo e(__('Description in English')); ?>"><?php echo e(old('description_en', $area->getTranslation('description', 'en'))); ?></textarea>
            </div>
...
<?php /**PATH C:\laragon\www\dalel-madinaty\resources\views/admin/areas/edit.blade.php ENDPATH**/ ?>