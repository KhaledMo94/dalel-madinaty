...
<?php $component->withAttributes([]); ?>
    ...
    ?>
    <div class="card-body">
        <form class="my-3" action="<?php echo e(route('admins.listings.store')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="col-3">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <a class="nav-link" id="p2_tab" data-toggle="pill" href="#p2" role="tab"
                                    aria-controls="p2" aria-selected="false"><?php echo e(__('Amenities, Category & Options')); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                    value="<?php echo e(old('name_ar')); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>"
                                                    value="<?php echo e(old('name_en')); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>" cols="30"
                                            rows="10"><?php echo e(old('description_ar')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" cols="30"
                                            rows="10"><?php echo e(old('description_en')); ?></textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="latitude" id="latitude"
                                                    class="form-control" value="<?php echo e(old('latitude')); ?>"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="longitude" id="longitude"
                                                    class="form-control" value="<?php echo e(old('longitude')); ?>"
...
unset($__errorArgs, $__bag); ?>" required>
                                            <option value="active" <?php if(old('status', 'active') == 'active'): echo 'selected'; endif; ?>><?php echo e(__('Active')); ?></option>
                                            <option value="inactive" <?php if(old('status') == 'inactive'): echo 'selected'; endif; ?>><?php echo e(__('Inactive')); ?></option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="file" name="banner_image" accept="image/*"
                                                class="<?php $__errorArgs = ['banner_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        <label for="images"><?php echo e(__('Additional Images')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                        <small
                                            class="form-text text-muted"><?php echo e(__('You can add multiple images one at a time')); ?></small>
                                    </div>
                                    <div class="form-group">
        ...
        $(document).ready(function() {
            ...
            function validateSocialLink(input, pattern, errorElementId, platformName) {
                ...
                if (pattern.test(value)) {
                    ...
                    errorElement.text('<?php echo e(__("Please enter a valid")); ?> ' + platformName + ' <?php echo e(__("URL")); ?>')
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\dalel-madinaty\resources\views/admin/listings/create.blade.php ENDPATH**/ ?>