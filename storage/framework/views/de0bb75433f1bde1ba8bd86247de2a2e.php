...
<?php $component->withAttributes([]); ?>
    ...
    <div class="card-body">
        ...
        <h1 class="mb-3 text-gray-800 h3"><?php echo e(__('Create Commenter')); ?></h1>

        <form class="my-3" action="<?php echo e(route('admins.commenters.store')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="name" placeholder="<?php echo e(__('Name')); ?>" required value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="email" placeholder="<?php echo e(__('Email')); ?>" value="<?php echo e(old('email')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <label for="email_verified" class=""><?php echo e(__('Email Verified')); ?></label>
                <select name="email_verified" class="form-control" id="email_verified">
                    <option value="1" <?php if(old('email_verified') == true): echo 'selected'; endif; ?>><?php echo e(__('Yes')); ?></option>
                    <option value="0" <?php if(old('email_verified') == false): echo 'selected'; endif; ?>><?php echo e(__('No')); ?></option>
                </select>
            </div>
...
unset($__errorArgs, $__bag); ?>" 
                    placeholder="<?php echo e(__('Country Code')); ?>" required value="<?php echo e(old('country_code', '+20')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <select name="phone_verified" class="form-control" id="phone_verified">
                    <option value="1" <?php if(old('phone_verified') == true): echo 'selected'; endif; ?>><?php echo e(__('Yes')); ?></option>
                    <option value="0" <?php if(old('phone_verified') == false): echo 'selected'; endif; ?>><?php echo e(__('No')); ?></option>
                </select>
            </div>
...
unset($__errorArgs, $__bag); ?>" required>
                    ...
                    <?php $__currentLoopData = $listings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($listing->id); ?>" <?php if(old('commenter_id') == $listing->id): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <select name="status" class="form-control" id="status" required>
                    <option value="active" <?php if(old('status') == 'active'): echo 'selected'; endif; ?>><?php echo e(__('Active')); ?></option>
                    <option value="inactive" <?php if(old('status') == 'inactive'): echo 'selected'; endif; ?>><?php echo e(__('Banned')); ?></option>
                </select>
            </div>

            <div class="form-group">
                <label for="image" class="for"><?php echo e(__('Image')); ?></label>
                <input type="file" name="image" class="form-control" id="image" accept="image/*" placeholder="<?php echo e(__('Image')); ?>">
            </div>

            <button type="submit" class="btn btn-success btn-block mb_40"><?php echo e(__('Create Commenter')); ?></button>
...
<?php /**PATH C:\laragon\www\dalel-madinaty\resources\views/admin/commenters/create.blade.php ENDPATH**/ ?>