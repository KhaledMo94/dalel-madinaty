...
<?php $component->withAttributes([]); ?>
    ...
    ?>
    <h1 class="mb-3 text-gray-800 h3"><?php echo e(__('Branches')); ?></h1>
    <div class="mb-4 shadow card">
        <div class="py-3 card-header">
            <h6 class="m-0 mt-2 font-weight-bold text-primary"></h6>
            <div class="float-right d-inline">
                <a href="<?php echo e(route('admins.branches.create')); ?>" class="btn btn-primary btn-sm">
...
[$__name, $__params] = $__split('branches-index', ['cities' => $cities, 'areas' => $areas]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2902873968-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /home/khaled/projects/dalel-madinaty/resources/views/admin/branches/index.blade.php ENDPATH**/ ?>