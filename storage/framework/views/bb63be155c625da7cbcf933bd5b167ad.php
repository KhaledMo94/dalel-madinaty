...
<?php $component->withAttributes([]); ?>
    ...
    <div class="card-body">
        <form class="my-3" action="<?php echo e(route('admins.cities.update', $city->id)); ?>" method="post"
            ...
            <div class="form-group">
                ...
                <input type="text" name="name_ar" class="form-control" id="name" placeholder="<?php echo e(__('Name')); ?>"
                    required value="<?php echo e(old('name_ar', $city->getTranslation('name', 'ar'))); ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="name_en" class="form-control" id="name"
                    ...
                    value="<?php echo e(old('name_en', $city->getTranslation('name', 'en'))); ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="description_ar" class="form-control" id="description_ar"
                    placeholder="<?php echo e(__('Description in Arabic')); ?>">
                    <?php echo e(old('description_ar', $city->getTranslation('description', 'ar'))); ?></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="description_en" class="form-control" id="description_en"
                    placeholder="<?php echo e(__('Description in English')); ?>"><?php echo e(old('description_en', $city->getTranslation('description', 'en'))); ?></textarea>
            </div>

            <div class="form-group">
                <label for=""><?php echo e(__('Existing Photo')); ?></label>
                <div>
                    <img src="<?php echo e(asset('storage/' . $city->image)); ?>" class="w_200" alt="">
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\dalel-madinaty\resources\views/admin/cities/edit.blade.php ENDPATH**/ ?>