...
<div wire:id="<?php echo e($this->getId()); ?>">
    <div class="mb-3 row">
        ...
        <div class="col-md-2">
            <label class="sr-only" for="startDateFilter"><?php echo e(__('Start Date')); ?></label>
        ...
        <div class="col-md-2">
            <label class="sr-only" for="endDateFilter"><?php echo e(__('End Date')); ?></label>
...
<?php /**PATH C:\laragon\www\dalel-madinaty\resources\views/livewire/offers-index.blade.php ENDPATH**/ ?>