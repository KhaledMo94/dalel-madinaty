...
<?php $component->withAttributes([]); ?>
    ...
    <h1 class="mb-3 text-gray-800 h3"><?php echo e(__('Create Offer')); ?></h1>
    <div class="mb-4 shadow card">
        ...
        <div class="card-body" data-aos="fade-up">
            ...
            <form class="my-3" action="<?php echo e(route('admins.offers.store')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                required value="<?php echo e(old('content_en')); ?>" maxlength="150">
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                required value="<?php echo e(old('content_ar')); ?>" maxlength="150">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\dalel-madinaty\resources\views/admin/offers/create.blade.php ENDPATH**/ ?>