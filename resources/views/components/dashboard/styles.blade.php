...
<link rel="stylesheet" href="{{ asset('backend/css/modern-theme.css') }}">
<link rel="stylesheet" href="{{ asset('backend/css/sidebar-modern.css') }}">
<link rel="stylesheet" href="{{ asset('backend/css/sidebar-fixes.css') }}">
