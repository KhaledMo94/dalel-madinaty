<x-dashboard.main-layout>
    ...
    <h1 class="mb-3 text-gray-800 h3">{{ __('Create Offer') }}</h1>
    <div class="mb-4 shadow card">
        ...
        <div class="card-body" data-aos="fade-up">
            ...
            <form class="my-3" action="{{ route('admins.offers.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="content_en" id="content_en" 
                                ...
                                required value="{{ old('content_en') }}" maxlength="150">
                            @error('content_en')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="content_ar" id="content_ar" 
                                ...
                                required value="{{ old('content_ar') }}" maxlength="150">
                            @error('content_ar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
