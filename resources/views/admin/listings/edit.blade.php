<x-dashboard.main-layout>
    ...
    @endphp
    <div class="card-body">
        <form class="my-3" action="{{ route('admins.listings.update', $listing->id) }}" method="post"
                        ...
                        <div class="col-3">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <a class="nav-link" id="p2_tab" data-toggle="pill" href="#p2" role="tab"
                                    aria-controls="p2" aria-selected="false">{{ __('Amenities & Category') }}
                                </a>
                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="p1" role="tabpanel"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name_ar" class="form-control"
                                                    value="{{ old('name_ar') ?? $listing->getTranslation('name', 'ar') }}"
                                                    autofocus>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name_en" class="form-control"
                                                    value="{{ old('name_en') ?? $listing->getTranslation('name', 'en') }}"
                                                    autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description_ar" class="form-control" cols="30" rows="10">{{ old('description_ar') ?? $listing->getTranslation('description', 'ar') }}</textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="">{{ __('Description In English') }}</label>
                                        <textarea name="description_en" class="form-control" cols="30" rows="10">{{ old('description_en') ?? $listing->getTranslation('description', 'en') }}</textarea>
                                    </div>
                                    
                                                                        <div class="form-group">
                                        <label for="">{{ __('Facebook') }}</label>
                                        <input type="text" name="fb_link" class="form-control"
                                                value="{{ old('fb_link') ?? $listing->fb_link }}" >
                                    </div>
                                    <div class="form-group">
                                        <label for="">{{ __('Tik Tok') }}</label>
                                                <input type="text" name="tt_link" class="form-control"
                                                    value="{{ old('tt_link') ?? $listing->tt_link }}" >
                                            </div>
                                    <div class="form-group">
                                        <label for="">{{ __('Instagram') }}</label>
                                        <input type="text" name="insta_link" class="form-control"
                                            value="{{ old('insta_link') ?? $listing->insta_link }}">
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="latitude" id="latitude" class="form-control"
                                                    value="{{ old('latitude') ?? $listing->latitude }}" placeholder="e.g., 30.0444">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="longitude" id="longitude" class="form-control"
                                                    value="{{ old('longitude') ?? $listing->longitude }}" placeholder="e.g., 31.2357">
                                                <small class="form-text text-muted">{{ __('Optional') }}</small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control @error('status') is-invalid @enderror" required>
                                            <option value="active" @selected((old('status') ?? $listing->status) == 'active')>{{ __('Active') }}</option>
                                            <option value="inactive" @selected((old('status') ?? $listing->status) == 'inactive')>{{ __('Inactive') }}</option>
                                        </select>
                                        @error('status')
                                ...
                                <div class="tab-pane fade" id="p2" role="tabpanel" aria-labelledby="p2_tab">
                                    ...
                                    <div class="form-group" wire:ignore>
                                        ...
                                        <select name="category_id" id="select_category" class="form-control">
                                            <option selected value="{{ $listing->category_id }}">
                                    ...
                                    <div class="mt-4" id="amenities_section">
                                        ...
                                        <select name="amenities_ids[]" id="select_amenities" class="form-control" multiple>
                                            @foreach ($listing->amenities as $amenity)
                                                <option selected value="{{ $amenity->id }}">
                                                    {{ $amenity->getTranslation('name', app()->getLocale()) }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="p3" role="tabpanel" aria-labelledby="p3_tab">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            @if ($listing->banner_image)
                                                <img src="{{ asset('storage/' . $listing->banner_image) }}" class="w_200"
                                                    alt="">
                                            @else
                                                <p>{{ __('No Image') }}</p>
                                            @endif
                                    ...
                                    <div class="form-group">
                                        <label for="images">{{ __('Listing Images') }}</label>
                                                    ...
                                                    @foreach($listing->images as $image)
                                                        <div class="col-md-3 mb-3 existing-image-item" data-image-id="{{ $image->id }}">
                                                            <div class="position-relative border rounded p-2">
                                                                ...
                                                                <input type="hidden" name="existing_images_ids[]" value="{{ $image->id }}" class="existing-image-input">
                                        ...
                                        <div class="new-images-container">
                                            ...
                                            @enderror
                                            <small class="form-text text-muted">{{ __('You can add multiple images one at a time') }}</small>
                                        </div>
                                    </div>
                                </div>
                                <!-- // Tab 3 -->
                ...
                $.ajax({
                    ...
                    success: function(options) {
                        ...
                        if (options.length > 0) {
                            ...
                            var existingOptionValueIds = @json($listing->optionValues->pluck('id')->toArray());
