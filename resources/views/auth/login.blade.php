                            ...
                            <div class="col-lg-12" style="background-color: # f9f6ed">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        <img src="{{ asset(config('app.logo')) }}" alt="Logo" class="mb-4"
                                    ...
                                    <form action="{{ route('login') }}" class="user" method="post">
                                        ...
                                        <button type="submit"
                                            class="text-white btn btn-user btn-block"  style="background-color: rgb(189, 163, 86) ; font-family: 'Cairo', sans-serif; font-size:20px">{{ __('Login') }}
                                        </button>
                                    </form>
                                </div>
                            </div>
