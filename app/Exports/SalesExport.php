...
class SalesExport implements FromCollection, WithHeadings, WithStyles, WithTitle, ShouldAutoSize, WithEvents
{
    /**
    ...
    public function collection(): Collection
    {
        ...
        return $this->listings->map(function ($listing) use ($locale) {
            return [
                ...
                $listing->users_count ?? (string)0,
                $listing->branches_count ?? (string) 0,
