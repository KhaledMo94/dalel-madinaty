...
use App\Http\Middleware\AuthorizedUserTypeCheckMiddleware;
use App\Http\Middleware\ChangeLanguageForMobileMiddleware;
use App\Http\Middleware\CheckUserActivityBySanctum;
use App\Http\Middleware\CheckUserHasValidPaymentMiddleware;
...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        $middleware->alias([
            ...
            'payed'                                     =>CheckUserHasValidPaymentMiddleware::class,
            'type'                                      =>AuthorizedUserTypeCheckMiddleware::class,
        ]);
